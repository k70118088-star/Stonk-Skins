export const BoxHelper = [
  { text: "Fast Transactions", icon: "fast" },
  { text: "Verified Users", icon: "verified" },
  { text: "24/7 Support", icon: "support" },
  { text: "No Hidden Fees", icon: "hidden" },
];

export const Products = [
  { id: 1, image: "/assets/gun1.png" },
  { id: 2, image: "/assets/gun2.png" },
  { id: 3, image: "/assets/gun3.png" },
  { id: 4, image: "/assets/gun1.png" },
  { id: 5, image: "/assets/gun5.png" },
  { id: 6, image: "/assets/gun4.png" },
  { id: 7, image: "/assets/gun2.png" },
  { id: 8, image: "/assets/gun3.png" },
  { id: 9, image: "/assets/gun1.png" },
];


export const Sections = [
    { className: "lg:left-32" , mt: "-mt-0.5 pt-14 sm:pt-18 md:pt-22 lg:pt-26" },
    { className: "lg:right-36.5" , mt: "-mt-0.5 pt-14 sm:pt-18 md:pt-22 lg:pt-36" },
    { className: "" , mt: "-mt-0.5 pt-14 sm:pt-18 md:pt-22 lg:pt-36" },
  ];
